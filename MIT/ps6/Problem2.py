...
class PlaintextMessage(Message):
    def __init__(self, text, shift):
        ...
        msg = Message(text)
        self.message_text = text
        self.valid_words = Message(text).get_valid_words()
        self.shift = shift
        self.encrypting_dict = msg.build_shift_dict(shift).copy()
...
#        pass #delete this line and replace with your code here
    ...
    def get_message_text_encrypted(self):
        ...
        '''
#        self.message_text_encrypted = Message(self.message_text).apply_shift(self.shift)        
#        return self.message_text_encrypted
    ...
    def change_shift(self, shift):
        ...
        if 0 <= shift < 26 :
            self.shift = shift
            self.encrypting_dict = Message(self.message_text).build_shift_dict(shift).copy()
            self.message_text_encrypted = Message(self.message_text).apply_shift(shift)
            
            #return PlaintextMessage(self.message_text, shift)
...
class CiphertextMessage(Message):
    ...
    def decrypt_message(self):
        ...
        for i in words:
            ...
            print i
            for k in range(26):
                word = ''#print Message(i).apply_shift(k).swapcase()
                word = Message(i).apply_shift(k).swapcase()
                #word = word.upper()                
                #print word
        ...
        return (l, w[:-1])    #print self.valid_words() 
                    #print Message(i).apply_shift(k)

#Example test case (PlaintextMessage)
story = get_story_string()
plaintext = PlaintextMessage(story, 0)
#test = plaintext.change_shift(7)
#print 'Expected Output: jgnnq'
#print 'Actual Output:', plaintext.get_message_text_encrypted()
#print  Message('jgnnq').apply_shift(24)
#plaintext.change_shift(24)  
#print 'Actual Output:', plaintext.get_message_text_encrypted()
